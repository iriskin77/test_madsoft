...
from file_service.app.repository.postgres.base import Base
from file_service.app.repository.postgres.models import Memes
from file_service.app.config.config import POSTGRES_HOST, POSTGRES_PORT, POSTGRES_DB, POSTGRES_USER, POSTGRES_PASSWORD
